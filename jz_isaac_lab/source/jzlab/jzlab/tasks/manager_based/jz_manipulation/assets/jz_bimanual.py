...
FORCE_USD_REBUILD = os.environ.get("JZLAB_FORCE_USD_REBUILD", "0").lower() in ("1", "true", "yes", "on")
ALLOW_STALE_USD_CACHE = os.environ.get("JZLAB_ALLOW_STALE_USD_CACHE", "1").lower() in ("1", "true", "yes", "on")
