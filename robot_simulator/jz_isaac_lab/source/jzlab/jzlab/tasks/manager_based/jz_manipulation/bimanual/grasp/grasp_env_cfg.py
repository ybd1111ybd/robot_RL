...
GRASP_HEIGHT_RAISE_Z = 0.18
TABLE_CENTER_Z = 0.83 + GRASP_HEIGHT_RAISE_Z
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        left_pregrasp_geometry: ObsTerm | None = None
        right_pregrasp_geometry: ObsTerm | None = None
...
class RewardsCfg:
    ...
    left_gripper_early_close: RewTerm | None = None
    right_gripper_early_close: RewTerm | None = None
    left_stable_finger_contact: RewTerm | None = None
    right_stable_finger_contact: RewTerm | None = None
    left_tcp_axes_alignment: RewTerm | None = None
    right_tcp_axes_alignment: RewTerm | None = None
    left_fingertip_surface_clearance: RewTerm | None = None
    right_fingertip_surface_clearance: RewTerm | None = None
    left_fingertip_grasp_center: RewTerm | None = None
    right_fingertip_grasp_center: RewTerm | None = None
    left_fingertip_surface_orientation: RewTerm | None = None
    right_fingertip_surface_orientation: RewTerm | None = None
    left_early_fingertip_contact: RewTerm | None = None
    right_early_fingertip_contact: RewTerm | None = None
    left_v2_clearance: RewTerm | None = None
    right_v2_clearance: RewTerm | None = None
    left_v2_gap_balance: RewTerm | None = None
    right_v2_gap_balance: RewTerm | None = None
    left_v2_between: RewTerm | None = None
    right_v2_between: RewTerm | None = None
    left_v2_horizontal: RewTerm | None = None
    right_v2_horizontal: RewTerm | None = None
    left_v2_vertical: RewTerm | None = None
    right_v2_vertical: RewTerm | None = None
    left_v2_level: RewTerm | None = None
    right_v2_level: RewTerm | None = None
    left_v2_z_axis: RewTerm | None = None
    right_v2_z_axis: RewTerm | None = None
    left_v2_approach_axis: RewTerm | None = None
    right_v2_approach_axis: RewTerm | None = None
    left_v2_too_close: RewTerm | None = None
    right_v2_too_close: RewTerm | None = None
    left_v2_contact_terminal: RewTerm | None = None
    right_v2_contact_terminal: RewTerm | None = None
    left_v3_distance: RewTerm | None = None
    right_v3_distance: RewTerm | None = None
    left_v3_tracking: RewTerm | None = None
    right_v3_tracking: RewTerm | None = None
    left_v3_progress: RewTerm | None = None
    right_v3_progress: RewTerm | None = None
    left_v4_radial_tracking: RewTerm | None = None
    right_v4_radial_tracking: RewTerm | None = None
    left_v4_radial_tracking_fine: RewTerm | None = None
    right_v4_radial_tracking_fine: RewTerm | None = None
    left_v4_height_tracking: RewTerm | None = None
    right_v4_height_tracking: RewTerm | None = None
    left_v4_height_tracking_fine: RewTerm | None = None
    right_v4_height_tracking_fine: RewTerm | None = None
    left_v4_radial_progress: RewTerm | None = None
    right_v4_radial_progress: RewTerm | None = None
    left_v4_radial_speed: RewTerm | None = None
    right_v4_radial_speed: RewTerm | None = None
    left_v4_relative_speed: RewTerm | None = None
    right_v4_relative_speed: RewTerm | None = None
    left_v4_persistent_contact: RewTerm | None = None
    right_v4_persistent_contact: RewTerm | None = None
    left_v4_stable_pregrasp: RewTerm | None = None
    right_v4_stable_pregrasp: RewTerm | None = None
    left_v41_radial_error: RewTerm | None = None
    right_v41_radial_error: RewTerm | None = None
    left_v41_height_error: RewTerm | None = None
    right_v41_height_error: RewTerm | None = None
    left_v42_scheduled_speed: RewTerm | None = None
    right_v42_scheduled_speed: RewTerm | None = None
    left_v42_inward_overshoot: RewTerm | None = None
    right_v42_inward_overshoot: RewTerm | None = None
    left_v43_radial_velocity: RewTerm | None = None
    right_v43_radial_velocity: RewTerm | None = None
    left_v43_tangential_speed: RewTerm | None = None
    right_v43_tangential_speed: RewTerm | None = None
    left_v43_inward_overshoot: RewTerm | None = None
    right_v43_inward_overshoot: RewTerm | None = None
    left_v44_safety_barrier: RewTerm | None = None
    right_v44_safety_barrier: RewTerm | None = None
    left_v44_full_contact: RewTerm | None = None
    right_v44_full_contact: RewTerm | None = None
    left_v44_palm_contact: RewTerm | None = None
    right_v44_palm_contact: RewTerm | None = None
    left_v44_persistent_contact: RewTerm | None = None
    right_v44_persistent_contact: RewTerm | None = None
...
class TerminationsCfg:
    ...
    left_early_fingertip_contact: DoneTerm | None = None
    right_early_fingertip_contact: DoneTerm | None = None
